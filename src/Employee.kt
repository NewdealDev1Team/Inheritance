...
class NormalEmployee(employeeName: String, employeeUUID: UUID,
    department : Department, contract:String, salary:Long) :
    Employee(employeeName, employeeUUID, department, contract, salary)

class FullTimeEmployee(employeeName: String, employeeUUID: UUID,
...
class PartTimeEmployee(employeeName: String, employeeUUID: UUID,
...
class SalesEmployee(employeeName: String, employeeUUID: UUID,
    department : Department, contract:String, salary: Long) :
